      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex items-center justify-center min-h-screen">
            ...
            <div className="bg-white rounded-lg p-8 z-20" style={{ width: '100vw', maxWidth: '800px' }}>
              <h2 className="text-2xl font-semibold text-center">Hi, I am Geekie Techie. How can I help you?</h2>
              <div
                className="bg-white rounded-lg p-8 z-20 max-h-96 overflow-y-auto"
              ...
              <div className="mt-4 flex">
                ...
                />
                <button
                  className="bg-secondary hover:bg-primary active:bg-opacity-50 text-neutal font-bold py-2 px-4 rounded-r-md"
