...
export default function ProfileSection({ data, userData }) {
			...
			<div class="py-8 px-8 max-w-sm mx-auto rounded-xl shadow-lg space-y-2 sm:py-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-6">
				...
				<div class="text-center space-y-2 sm:text-left">
					<div class="space-y-0.5">
						<p class="text-lg font-semibold">{userData ? userData.firstName : 'John'}</p>
						<p class="font-medium">{userData ? userData.lastName : 'Do'}</p>
					</div>
