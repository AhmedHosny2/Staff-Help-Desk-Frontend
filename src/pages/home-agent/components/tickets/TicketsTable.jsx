...
export default function TicketComponent() {
	...
	const filteredData = data?.filter((ticketData) => ticketData.ticket.status === 'open');
					...
					<div className="w-full max-w-screen-lg mx-auto">
						<div className="flex flex-col items-center my-8">
							<div className="indicator">
								<span className="indicator-item badge badge-secondary">TICKETS</span>
											...
											<tr key={ticketData.userData._id}>
												...
												<th>
													<button
														...
														onClick={() => handleIDClick(ticketData.ticket._id)}
													>
