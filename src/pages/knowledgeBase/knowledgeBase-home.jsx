                    ...
                    {isPending ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {finalArticles.map((article, index) => (
                                article.question && article.answer && article.category && article.subCategory ? (
                                    <div key={index} className="rounded overflow-hidden shadow-lg p-6 bg-secondary transform transition duration-700 ease-in-out hover:scale-105">
